...
<body>
	<section class="py-3"> <!--Section heading-->
	<div class="container">
		<h2 class="font-bold text-center h1 py-5"><b>캠페인 문의</b></h2>
		...
		<form id='registerForm' role="form" method="post"
			...
			<div class="card-body">
				...
				<div class="md-form">
					<i class="fa fa-paper-plane prefix grey-text"></i> <input
						name="title" type="text" id="form-email" class="form-control"
						placeholder="캠페인 제목">
				</div>
				...
				<div class="md-form">
					<i class="fa fa-calendar-o prefix grey-text"></i> <label>캠페인등록기간</label>
				</div>

				<br>
				<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>시작일<input
					type="date" name="periodStart" id="periodStart" /></label> <label>종료일<input
					type="date" name="periodStop" id="periodStop" /></label> <br>
				<br>
				...
				<form method="post" enctype='multipart/form-data' target="fileIframe">
					<input type="file" name='f1'>
					<button>Upload</button>
				</form>
				<iframe name="fileIframe"></iframe>
 -->
				<br>
